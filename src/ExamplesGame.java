...
public class ExamplesGame {
    ...
    Powerup avocado = new Powerup(.17f, .50f, 600, new Posn(0, 0),
            new FromFileImage(new Posn(0, 0), "avocado.png"));
    Powerup twinkie = new Powerup(-0.1f, -0.35f, -100, new Posn(0, 0),
            new FromFileImage(new Posn(0, 0), "twinkie.png"));
    ...
    void testUpdateStats(Tester t) {
        ...
        t.checkExpect(player, new Player(751f, 7.7f, 600, new Posn(0,
                CollectTheFruit.height - 30)));
        resetPlayer();
        player.updateStats(twinkie);
        t.checkExpect(player, new Player(630f, 3.9f, 0, new Posn(0,
                CollectTheFruit.height - 30)));
    }
    ...
    void testGetYPos(Tester t) {
        t.checkOneOf(field.getYPos(), CollectTheFruit.height - 35,
