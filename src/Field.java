...
public class Field {
    ...
    /*
     * void makeMeat() { this.hungerDeltaPcrntArray.add(0.55f);
     * this.SpeedDeltaPcrntArray.add(0.10f); this.pointsDeltaArray.add(550);
     * this.ImageLocationArray.add("meat.png"); }
     * 
     * void makeBroccoli() { this.hungerDeltaPcrntArray.add(0.07f);
     * this.SpeedDeltaPcrntArray.add(0.05f); this.pointsDeltaArray.add(1400);
     * this.ImageLocationArray.add("broccoli.png"); }
     * 
     * void makeBanana() { this.hungerDeltaPcrntArray.add(0.22f);
     * this.SpeedDeltaPcrntArray.add(0.15f); this.pointsDeltaArray.add(250);
     * this.ImageLocationArray.add("broccoli.png"); }
     * 
     * void makeGrape() { this.hungerDeltaPcrntArray.add(0.08f);
     * this.SpeedDeltaPcrntArray.add(0.10f); this.pointsDeltaArray.add(75);
     * this.ImageLocationArray.add("grape.png"); }
     * 
     * void makeCookie() { this.hungerDeltaPcrntArray.add(0.03f);
     * this.SpeedDeltaPcrntArray.add(-0.10f); this.pointsDeltaArray.add(30);
     * this.ImageLocationArray.add("cookie.png"); }
     * 
     * void makeDonut() { this.hungerDeltaPcrntArray.add(-0.15f);
     * this.SpeedDeltaPcrntArray.add(-0.1f); this.pointsDeltaArray.add(10);
     * this.ImageLocationArray.add("donut.png"); }
     * 
     * void makeFries() { this.hungerDeltaPcrntArray.add(0.11f);
     * this.SpeedDeltaPcrntArray.add(-0.25f); this.pointsDeltaArray.add(20);
     * this.ImageLocationArray.add("fries.png"); }
     * 
     * void makeChocolate() { this.hungerDeltaPcrntArray.add(0.05f);
     * this.SpeedDeltaPcrntArray.add(-0.2f); this.pointsDeltaArray.add(5);
    ...
    Field() {
        makeAvocado();
        /*
         * makeMeat(); makeBroccoli(); makeBanana(); makeGrape(); makeCookie();
         * makeDonut(); makeFries(); makeChocolate();
         */
        makeTwinkie();
